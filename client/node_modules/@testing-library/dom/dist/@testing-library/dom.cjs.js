...
const shouldHighlight = () => {
  ...
  try {
    var _process;
    const colors = (_process = process) == null || (_process = _process.env) == null ? void 0 : _process.COLORS;
    if (colors) {
  ...
  return !!((_process2 = process) != null && (_process2 = _process2.versions) != null && _process2.node);
};
const {
  DOMCollection
